...
namespace PicklesDoc.Pickles.Test
{
    ...
    public class WhenCrawlingFoldersForFeatures : BaseFixture
    {
        ...
        public void Then_can_crawl_all_folders_including_subfolders_for_features_successfully()
        {
            ...
            var rootPath = FileSystem.DirectoryInfo.FromDirectoryName(Path.Combine(FileSystemPrefix,"FeatureCrawlerTests"));
            ...
            Check.That(levelOneSublevelOneFeature.RelativePathFromRoot).IsEqualTo(Path.Combine("SubLevelOne","LevelOneSublevelOne.feature"));
            ...
            Check.That(levelOneSublevelTwoFeature.RelativePathFromRoot).IsEqualTo(Path.Combine("SubLevelOne","LevelOneSublevelTwo.feature"));
            ...
            Check.That(subLevelTwoDirectory.RelativePathFromRoot).IsEqualTo(Path.Combine("SubLevelOne","SubLevelTwo")+Path.DirectorySeparatorChar);
            ...
            Check.That(levelOneSublevelOneSubLevelTwoDirectory.RelativePathFromRoot).IsEqualTo(Path.Combine("SubLevelOne","SubLevelTwo","LevelOneSublevelOneSubLevelTwo.feature"));
